...
def parse_args():
    ...
    parser.add_argument("--task", default=None, help="The task for the ESG agent.")
    parser.add_argument(
        '--cfg-options',
        nargs='+',
        action=DictAction,
...
async def main():
    ...
    files = [] # No files attached for this example

    logger.info(f"| 📋 ESG Task: {task}")
    ...
    logger.info(f"| 🎉 ESG Agent finished with result: {result}")
