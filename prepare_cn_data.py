## Refer from alphaagent prepare_cn_data.py
...
--data_path  ./datasets/qlib_data/cn_data/raw_data_now \
--qlib_dir ./datasets/qlib_data/cn_data \
--date_field_name date \
--symbol_field_name code

# Collect calendar data
python scripts/data_collector/future_calendar_collector.py --qlib_dir ./datasets/qlib_data/cn_data/ --region cn


# Download the CSI500/CSI300/CSI100 stock universe
python scripts/data_collector/cn_index/collector.py --index_name CSI500 --qlib_dir ./datasets/qlib_data/cn_data/ --method parse_instruments
"""
...
def get_zz_500_stocks():
    ...
    while rs.next():
        ...
        zz500_stocks.add(row_dict["code"])   # 注意：add，不是 update
    return zz500_stocks
...
if __name__ == '__main__':
    ...
    DATA_DIR = r'./datasets/qlib_data/cn_data/raw_data_back_adjust'
