...
from src.environments.browser.logging_config import setup_logging

# Only set up logging if not in MCP mode or if explicitly requested
if os.environ.get('BROWSER_USE_SETUP_LOGGING', 'true').lower() != 'false':
	from src.environments.browser.config import CONFIG
...
if TYPE_CHECKING:
	from src.environments.browser.browser import BrowserProfile, BrowserSession
	from src.environments.browser.browser import BrowserSession as Browser
	from src.environments.browser.dom.service import DomService


# Lazy imports mapping - only import when actually accessed
_LAZY_IMPORTS = {
	'BrowserSession': ('src.environments.browser.browser', 'BrowserSession'),
