...
from src.environments.browser.utils import _log_pretty_path, logger
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	proxy: ProxySettings | None = Field(
		default=None,
		description='Proxy settings. Use src.environments.browser.browser.profile.ProxySettings(server, bypass, username, password)',
	)
