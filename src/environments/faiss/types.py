...
class FaissConfig(BaseModel):
    ...
    distance_strategy: str = Field("euclidean", description="Distance strategy (euclidean, cosine, max_inner_product)")
    ...
    auto_save: bool = Field(True, description="Whether to auto-save the index")
