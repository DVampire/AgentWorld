...
from src.environments.cdp_browser.dom.views import (
	EnhancedDOMTreeNode,
	SerializedDOMState,
)
...
if TYPE_CHECKING:
	from src.environments.cdp_browser.browser.views import BrowserStateSummary, PageInfo
...
class DOMWatchdog(BaseWatchdog):
		...
		try:
			...
			if screenshot_b64 and content and content.selector_map and self.browser_session.browser_profile.highlight_elements:
				try:
					...
					from src.environments.cdp_browser.browser.python_highlights import create_highlighted_screenshot_async
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from src.environments.cdp_browser.browser.views import PageInfo
