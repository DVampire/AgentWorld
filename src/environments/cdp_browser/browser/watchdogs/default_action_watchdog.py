...
from src.environments.cdp_browser.browser.views import BrowserError, URLNotAllowedError
		...
		try:
			...
			if new_target_ids:
				...
				if not event.while_holding_ctrl:
					...
					from src.environments.cdp_browser.browser.events import SwitchTabEvent
