...
from src.environments.cdp_browser.browser.cloud import CloudBrowserAuthError, CloudBrowserError, get_cloud_browser_cdp_url
...
from src.environments.cdp_browser.browser.events import (
...
from src.environments.cdp_browser.browser.profile import BrowserProfile, ProxySettings
from src.environments.cdp_browser.browser.views import BrowserStateSummary, TabInfo
from src.environments.cdp_browser.dom.views import EnhancedDOMTreeNode, TargetInfo
from src.environments.cdp_browser.observability import observe_debug
from src.environments.cdp_browser.utils import _log_pretty_url, is_new_tab_page

if TYPE_CHECKING:
	from src.environments.cdp_browser.actor.page import Page
...
class BrowserSession(BaseModel):
	...
	async def kill(self) -> None:
		...
		from src.environments.cdp_browser.browser.events import SaveStorageStateEvent
	...
	async def attach_all_watchdogs(self) -> None:
		...
		from src.environments.cdp_browser.browser.watchdogs.local_browser_watchdog import LocalBrowserWatchdog
		from src.environments.cdp_browser.browser.watchdogs.permissions_watchdog import PermissionsWatchdog
		from src.environments.cdp_browser.browser.watchdogs.popups_watchdog import PopupsWatchdog
		from src.environments.cdp_browser.browser.watchdogs.recording_watchdog import RecordingWatchdog
		from src.environments.cdp_browser.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
		from src.environments.cdp_browser.browser.watchdogs.security_watchdog import SecurityWatchdog
		from src.environments.cdp_browser.browser.watchdogs.storage_state_watchdog import StorageStateWatchdog
