...
from src.environments.playwright.browser.cloud import CloudBrowserAuthError, CloudBrowserError, get_cloud_browser_cdp_url
...
from src.environments.playwright.browser.profile import BrowserProfile, ProxySettings
from src.environments.playwright.browser.views import BrowserStateSummary, TabInfo
from src.environments.playwright.dom.views import EnhancedDOMTreeNode, TargetInfo
from src.environments.playwright.observability import observe_debug
from src.environments.playwright.utils import _log_pretty_url, is_new_tab_page

if TYPE_CHECKING:
	from src.environments.playwright.actor.page import Page
...
class BrowserSession(BaseModel):
	...
	def model_post_init(self, __context) -> None:
		...
		from src.environments.playwright.browser.watchdog_base import BaseWatchdog
	...
	async def kill(self) -> None:
		...
		from src.environments.playwright.browser.events import SaveStorageStateEvent
	...
	async def new_page(self, url: str | None = None) -> 'Page':
		...
		from src.environments.playwright.actor.page import Page as Target
	...
	async def attach_all_watchdogs(self) -> None:
		...
		# from src.environments.playwright.browser.watchdogs.crash_watchdog import CrashWatchdog
		from src.environments.playwright.browser.watchdogs.aboutblank_watchdog import AboutBlankWatchdog
		from src.environments.playwright.browser.watchdogs.default_action_watchdog import DefaultActionWatchdog
		from src.environments.playwright.browser.watchdogs.dom_watchdog import DOMWatchdog
		from src.environments.playwright.browser.watchdogs.downloads_watchdog import DownloadsWatchdog
		from src.environments.playwright.browser.watchdogs.local_browser_watchdog import LocalBrowserWatchdog
		from src.environments.playwright.browser.watchdogs.permissions_watchdog import PermissionsWatchdog
		from src.environments.playwright.browser.watchdogs.popups_watchdog import PopupsWatchdog
		from src.environments.playwright.browser.watchdogs.recording_watchdog import RecordingWatchdog
		from src.environments.playwright.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
		from src.environments.playwright.browser.watchdogs.security_watchdog import SecurityWatchdog
		from src.environments.playwright.browser.watchdogs.storage_state_watchdog import StorageStateWatchdog
	...
	async def connect(self, cdp_url: str | None = None) -> Self:
		...
		try:
			...
			from src.environments.playwright.utils import is_new_tab_page
