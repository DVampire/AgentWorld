...
from src.environments.playwright.browser.views import BrowserError, URLNotAllowedError
		...
		try:
			...
			if new_target_ids:
				...
				if not event.while_holding_ctrl:
					...
					from src.environments.playwright.browser.events import SwitchTabEvent
