...
class OfflineTradingPrompt(Prompt):
    """Prompt template for offline trading agents."""
    model_config = ConfigDict(arbitrary_types_allowed=True, extra="allow")
    
    name: str = Field(default="offline_trading", description="The name of the prompt")
    description: str = Field(default="Prompt for offline trading agents", description="The description of the prompt")
