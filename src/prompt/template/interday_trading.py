...
class InterdayTradingPrompt(Prompt):
    """Prompt template for interday trading agents."""
    model_config = ConfigDict(arbitrary_types_allowed=True, extra="allow")
    
    name: str = Field(default="interday_trading", description="The name of the prompt")
    description: str = Field(default="Prompt for interday trading agents", description="The description of the prompt")
