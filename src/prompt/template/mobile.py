...
class MobilePrompt(Prompt):
    """Prompt template for mobile agents."""
    model_config = ConfigDict(arbitrary_types_allowed=True, extra="allow")
    
    name: str = Field(default="mobile", description="The name of the prompt")
    description: str = Field(default="Prompt for mobile agents", description="The description of the prompt")
